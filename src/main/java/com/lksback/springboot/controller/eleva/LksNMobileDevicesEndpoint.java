...
/**
 * @Classname LksNMobileDevicesEndpoint
 * @Description TODO
...
public class LksNMobileDevicesEndpoint {

    @Autowired
    private LksNmobileDevicesService modelByService;
    ...
    /**
     * 查询全部
     * fetch mobileDevices list
     * @return
     */

    @RequestMapping(value = "", method = RequestMethod.GET)
    public List<LksNmobileDevicesDto> fetchmobileDevices(){
    ...
    public List<LksNmobileDevicesDto> fetchmobileDevices(@PathVariable Integer page
    ...
    public LksNmobileDevicesDto fetchmobileDevices(@PathVariable String reference){
        LksNmobileDevicesDto byReference = modelByService.findByReference(reference);
        if (byReference == null){
    ...
    public LksNmobileDevicesDto SavemobileDevices(@RequestBody LksNmobileDevicesDto modelDto){
        System.out.println("================");
    ...
    public LksNmobileDevicesDto UpdatemobileDevices(@RequestBody LksNmobileDevicesDto modelDto){
        LksNmobileDevicesDto byReference = modelByService.findByReference(modelDto.getReference());
    ...
    public LksNmobileDevicesDto deleteModel(@PathVariable String reference) {
        LksNmobileDevicesDto deleteModelDto = modelByService.findByReference(reference);
